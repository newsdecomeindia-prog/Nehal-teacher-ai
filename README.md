...
## Project Structure
- `backend/`: FastAPI backend service powering curriculum APIs, Suman AI teacher interaction, multi-modal voice/image services, and English speaking engine.
...
- `scripts/`: Verification scripts for Phase 0 through Phase 5.
