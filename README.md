...
## Project Structure
- `backend/`: FastAPI backend service powering curriculum APIs, Suman AI teacher interaction, multi-modal voice/image services, English speaking engine, and Knowledge World story engine.
- `mobile/`: Flutter client application data models and service abstractions.
- `docs/`: Technical specification documents and architecture guides.
- `scripts/`: Verification scripts for Phase 0 through Phase 6.
