...
def build_system_prompt(
    ...
    if subject_context or concept_context or learning_outcomes:
        ...
        if learning_outcomes:
            rag_grounding_section += "Target Learning Outcomes:\n" + "\n".join(
                [f"  * {outcome}" for outcome in learning_outcomes]
            ) + "\n"
        rag_grounding_section += (
    ...
    system_prompt = f"""You are {SUMAN_PERSONA_NAME}, a warm, supportive teacher.
...
- If a student expresses confusion, do NOT repeat the same explanation.
- Break down the concept into a simple 2-sentence story or real-world analogy.
